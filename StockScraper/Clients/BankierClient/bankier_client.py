...
class BankierClient(JSONClient, HTTPClient):    # type: ignore
    ...
    def call_endpoint(self, method: str, endpoint: str, *args: List[Any], **kwargs: Dict[Any, Any]) -> dict:
    ...
    def create_endpoint_url(symbol: str,
        ...
        endpoint_url += '&'.join([key + '=' + value for key, value in settings.items()])
        return endpoint_url
